...
import bg_cream_1 from "./assets/bg-cream-1.jpg";

import type { Couple, CoupleInfo } from "@/features/invitation/types";
import WeddingGiftCard from "../fantasy-1/sections/gift";
import moment from "moment";
import WILabel from "@/shared/components/ui/WILabel";
import LoveStoryOnboarding from "../fantasy-1/sections/loveStory";
import WeddingGalleryCarousel from "../fantasy-1/sections/carousel";
import RSVPCard from "../fantasy-1/sections/rsvp";
import BestWishesCard from "../fantasy-1/sections/wishes";
import WeddingInviteEndingCard from "../fantasy-1/sections/end";
import WeddingEventCards from "../fantasy-1/sections/weddingEvent";
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute mt-[-120px] md:mt-[-120px] inset-0 flex flex-col items-center justify-center text-white space-y-8">
        ...
        <div className="absolute inset-x-0 mt-130 ml-auto mr-auto w-[60%] [@media(min-height:800px)]:w-[300px] max-w-[90%] pb-12">
